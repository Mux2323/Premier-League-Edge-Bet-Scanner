...
# === CONFIGURATION ===
API_KEY = "d2ca42e1d4a40c79127a1cf2b0b291e3"
...
INCLUDED_BOOKS = {
    ...
    "caesars", "betmgm", "thescorebet", "888sport", "betrivers", "northstarbets"
}
...
DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1355284497641242914/BQl4Cz_ErX96ELmPwqSele3ViMRp1rEYN58z8ngvRpvzetaxqTlhqCNtE2hulSspFtCz"
...
def parse_and_find_edges(events):
    ...
    for event in events:
        ...
        for book in INCLUDED_BOOKS:
            ...
            sharp_home = market_lines["pinnacle"]["home"]
            sharp_draw = market_lines["pinnacle"]["draw"]
            sharp_away = market_lines["pinnacle"]["away"]
            fair_home, fair_draw, fair_away = three_way_devig(sharp_home, sharp_draw, sharp_away)
